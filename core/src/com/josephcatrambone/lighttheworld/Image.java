 ...
 * @author Nathan Sweet
 * Stolen and Monkey Patched by Joseph Catrambone
 * Change description: imageWidth and imageHeight were not reassigned after setting drawable.
 * Min width and min height were not taken from the drawable. */
public class Image extends Widget {
	...
	public void setDrawable (Drawable drawable) {
		...
		if (drawable != null) {
			this.imageWidth = drawable.getMinWidth();
			this.imageHeight = drawable.getMinHeight();
	...
	public float getPrefWidth () {
		return imageWidth*getScaleX();
	}

	public float getPrefHeight () {
		return imageHeight*getScaleY();
	}
